...
public class Calculator {
	private String title = "간편계산기 ver1.0";
	 ...
	 * @return 정수형 덧셈결과
	 */
	private long addition(long no1, long no2) {
		return no1 + no2;
	}
	 ...
	 * @return 실수형 덧셈결과
	 */
	private double addition(double no1, double no2) {
		return no1 + no2;
	}
	
	private long subtraction(long no1, long no2) {
		return no1 - no2;
	}
	
	private double subtraction(double no1, double no2) {
		return no1 - no2;
	}
	
	private long multiply(long no1, long no2) {
		return no1 *  no2;
	}
	
	private double multiply(double no1, double no2) {
		return no1 * no2;
	}
	
	private long division(long no1, long no2) {
		return no1 / no2;
	}
	
	private double division(double no1, double no2) {
		return no1 / no2;
	}
